...
== Urls
  products_path
link: localhost:3000/produtos

  product_path(@produto)
link: localhost:3000/produtos/:tipo_produto/:url_do_produto

  services_path
link:localhost:3000/servicos

  service_path(@service)
link:localhost:3000/servicos

  about_path
link:localhost:3000/sobre-a-empresa

  contact_path
link:localhost:3000/contato
